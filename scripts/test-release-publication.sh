...
assert hashlib.sha256(local_section).hexdigest() == "9b218a7a21bb5432cd0ad27de014e4c9ab5c74f59ef5b8f36dab430bef3bfa12", (
    "local release section differs byte-for-byte from the 0b09ae9 base"
)
PY
}
