...
Test scenarios:
  happy: `contract` accepts only schema version 1, CPython, minimum 3.9, and maximum 3.14; `endpoints` resolves the local Python 3.9.25 and Python 3.14.6 binaries and reports both identities before returning zero. Covers AE1, AE3
