...
| Issue #7's prepared correction is unposted and issues #6, #8, #9, #10 stay open although `0086cff` merged their repairs | 2026-08-15 retro-interview-integrity retro | P2 | Immediate, human-owned at the Ship gate — post `.release-loop/briefs/issue-7-body.md` with the command in `.release-loop/briefs/issue-7-command.md`, then close the four repaired issues |
