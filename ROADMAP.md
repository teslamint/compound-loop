...
| Planning-time trigger audit: when planning writes its File structure section, diff the planned file list (and any known record-shape drift) against every open carry-forward row's trigger condition, folding fired rows into the plan or its Deferred section with a reason — four of six live rows' triggers fired in the 2026-07-24 cycle, three unnoticed until retro | 2026-07-24 evidence-tier-vocabulary retro (T1) | P2 | Next planning cycle (any plan with a File structure section) |
