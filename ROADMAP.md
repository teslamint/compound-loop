...
| Approved-artifact truth maintenance: retain command evidence for live assumptions, recheck it in planning, and require a committed deviation addendum when a contradiction or review introduces observable behavior | 2026-07-16 release-skill v0.2.0 retro | P2 | Update designing/planning and implementation-review handoff guidance, with validation or an example proving the addendum rule |
| Mutation/failure-state matrix for stateful ceremonies: success, forced-failure, rerun, rollback, and headless outcomes for every durable transition, with retained fixture evidence before unit review passes | 2026-07-16 release-skill v0.2.0 retro | P2 | Add required planning/reviewing guidance and an example covering commit → verify → tag and publication states |
